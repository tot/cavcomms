	...
	public WebMvcConfigurer corsConfigurer() {
		return new WebMvcConfigurer() {
			...
			public void addCorsMappings(CorsRegistry registry) {
                ...
                registry.addMapping("/getconnection").allowedOrigins("http://localhost:1212");
                registry.addMapping("/killswitch").allowedOrigins("http://localhost:1212");
                registry.addMapping("/getstatuses").allowedOrigins("http://localhost:1212");
			}
		};
	}
